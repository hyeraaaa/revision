...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['bio'])) {
    try {
        ...
        header("Location: {$_SERVER['REQUEST_URI']}?bioUpdated=true");
        exit;
...
<body>
    ...
    <main>
                        ...
                        <div class="col-12 col-xxl-12 cover desktop-layout">
                            <div class="cover-photo-container" style="position: relative;">
                                ...
                                <form action="upload_photo.php" method="post" enctype="multipart/form-data" style="position: absolute; bottom: 10px; right: 10px;">
                                    <input type="file" name="coverPhoto" id="coverPhotoInput" style="display: none;" accept="image/*">
                                    <button type="button" class="edit-btn btn btn-light" data-bs-toggle="modal" data-bs-target="#changeCoverPhotoModal">
                                        Edit Cover Photo
                                    </button>
                                </form>
                            </div>
                                        ...
                                        <div class="card mb-3">
                                            <div class="profile-container-2 d-flex px-3 pt-3">
                                                <div class="profile-pic">
                                                    <img src="<?php echo '../uploads/' . htmlspecialchars($profile_picture); ?>" alt="Profile Picture" style="width: 30px;height: 30px; object-fit: cover;border-radius: 50%">
                                                </div>
                                    ...
                                    <div class="left-card">
                                        <div class="d-flex flex-column">
                                            <div class="bio-display-container">
                                                <p class="text-center"><?php echo htmlspecialchars($bio); ?></p>
                                            </div>
        ...
        <!-- update bio modal -->
        <div class="modal fade" id="bioUpdate" tabindex="-1" aria-labelledby="bioUpdateModal" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-sm">
                <div class="modal-content text-center">
                    <div class="modal-body p-4">
                        <div class="mb-2">
                        ...
                        <h6 class="modal-title mb-1" id="bioUpdateModal">Success</h6>
                        <p class="small mb-3">Bio has been updated.</p>
                        <button type="button" class="btn btn-success btn-sm w-100" data-bs-dismiss="modal">OK</button>
                    </div>
                </div>
            </div>
